      ...
      <div className="relative" ref={sidebarRef}>
        ...
        >
          ...
          <SidebarFooter className="p-3">
            <button
              onClick={toggleTheme}
              className="flex items-center gap-3 rounded-lg px-1 py-2 hover:bg-accent/50 transition-colors w-full group-data-[collapsible=icon]:justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
